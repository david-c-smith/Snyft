...
var foo2 = function() {
  var Particle = require('particle-api-js');
    ...
        var fnPr = particle.callFunction({ deviceId: '58003e000b51353335323536', name: 'location', argument: '4', auth: token });
...
var foo3 = function() {
  var Particle = require('particle-api-js');
    ...
        var fnPr = particle.callFunction({ deviceId: '58003e000b51353335323536', name: 'location', argument: '6', auth: token });
